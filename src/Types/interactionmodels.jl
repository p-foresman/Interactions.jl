...
struct GraphModel <: InteractionModel
    fn_var::Symbol
    # populations_size::Int #NOTE: required parameter to make GraphModel self-contained (not rely on Model)
    params::NamedTuple #(param=arg,) notation
    param_types::Tuple #might not need
    kwargs::Dict{Symbol, Any}

    function GraphModel(fn_var::Symbol, args::NamedTuple, kwargs::Dict{Symbol, <:Any}=Dict{Symbol, Any}())
