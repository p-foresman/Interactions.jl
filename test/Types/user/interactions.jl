@interaction function play_game!(state::Interactions.Types.State)
    ...
    function maximum_strategy(expected_utilities::Vector{Float64})
    ...
    function calculate_opponent_strategy_probabilities!(state::Interactions.Types.State, player_number::Integer)
    ...
    function find_opponent_strategy_probabilities!(state::Interactions.Types.State)
    ...
    function calculate_expected_utilities!(state::Interactions.Types.State)
    ...
    function make_choices!(state::Interactions.Types.State) #NOTE: this might have to be defined by users for true generality
    ...
    function push_memory!(agent::Interactions.Types.Agent, percept::Interactions.Types.Percept, memory_length::Int)
    ...
    function push_memories!(state::Interactions.Types.State)
